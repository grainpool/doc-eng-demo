/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0fb75a702e62e26d7af94e952e1b9f50)
// Runtime types generated with workerd@1.20260722.1 2026-07-01 nodejs_compat
interface __BaseEnv_Env {
	relay_artifacts: R2Bucket;
	relay_db: D1Database;
	ASSETS: Fetcher;
	KERNEL: DurableObjectNamespace<import("./src/index").RelayKernelContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RelayKernelContainer";
	}
